<?php  return array (
  ...
  array (
    ...
    'longtitle' => '',
    'description' => 'Карта сайта клиники Беласу.',
    'alias' => 'sitemap',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1345217211,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1345217211,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<meta name="description" content="Карта сайта клиники Беласу.">
...
<section id="content">
 <div class="clearfix">
  <h1 class="title border"><b>Карта сайта</b></h1>
  <div class="column span_12">
   [[!Wayfinder?
  &startId=`0`
  &outerTpl=`sitemap-outer`
  &rowTpl=`sitemap-row`
  &innerTpl=`sitemap-inner`
  &innerRowTpl=`sitemap-inner-row`
  &hereClass=``
  &firstClass=``
  &lastClass =`` ]]
  </div>
    ...
    <em><a href="/contacts" title="Вся контактная информация">Все контакты</a></em>
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'belasu-sitemap',
          'description' => 'Чанк для карты сайта.',
          'editor_type' => 0,
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '[[!Wayfinder?
